...
public class TestParserUtilsTest {
    ...
    public void test4() throws Exception {
        ...
        rootSymbol vRoot = (rootSymbol) vanillaParser.parseLine(vanillaRpyCode, true);
        parser patchParser = new parser();
        rootSymbol pRoot = (rootSymbol) patchParser.parseLine(patchRpyCode, true);
    ...
    public void test1() {
        ...
        rootSymbol rootSymbol = (rootSymbol) renpyParser.parseLine(rpyCode, true);
    ...
    public void test2() throws Exception {
        ...
        String rpyCode1 = """
                label one:
                    label xxxx:
                """;
        rootSymbol oldRootSymbol = (rootSymbol) oldRenpyParser.parseLine(rpyCode1, true);
        ...
        String newRpyCode = """
                label A:
                	...
                	return
                """;
        rootSymbol newRootSymbol = (rootSymbol) newRenpyParser.parseLine(newRpyCode, true);
    ...
    public void test3() throws Exception {
        ...
        rootSymbol sourceRoot = (rootSymbol) sourceParser.parseLine(rpyCode, true);
        parser patchParser = new parser();
        String newRpyCode = """
                label A:
                	label B:
                	...
                	return
                """;
        rootSymbol patchRoot = (rootSymbol) patchParser.parseLine(newRpyCode, true);
    ...
    public void test12() throws Exception {
        ...
        parser vanillaParser = new parser();
        parser patchParser = new parser();
        rootSymbol vRoot = (rootSymbol) vanillaParser.parseLine(rpyCode, true);
        rootSymbol pRoot = (rootSymbol) patchParser.parseLine(patchRpyCode, true);
    ...
    public void test16() throws Exception {
        ...
        parser vanillaParser = new parser();
        parser patchParser = new parser();
        rootSymbol vRoot = (rootSymbol) vanillaParser.parseLine(vanillaCode, true);
        rootSymbol pRoot = (rootSymbol) patchParser.parseLine(patchRpyCode, true);
