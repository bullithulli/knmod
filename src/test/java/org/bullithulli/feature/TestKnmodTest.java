...
public class TestKnmodTest {
    ...
    public void test16() throws Exception {
        String solution = String.format("""
                ...
                """, version, version);
        Modder2 modder2 = new Modder2();
        String absolutePath = Objects.requireNonNull(getClass().getClassLoader().getResource("knmodtests/e.rpy")).getPath();
        modder2.verifyAndExecuteKNModFeature(absolutePath, null, null);
        String content = new String(Files.readAllBytes(Paths.get("/tmp/out")));
        assertEquals(solution, content);
    }
    ...
    public void test17() throws Exception {
        String solution = String.format("""
                ...
                """, version, version);
        Modder2 modder2 = new Modder2();
        String absolutePath = Objects.requireNonNull(getClass().getClassLoader().getResource("knmodtests/f.rpy")).getPath();
        modder2.verifyAndExecuteKNModFeature(absolutePath, null, null);
        String content = new String(Files.readAllBytes(Paths.get("/tmp/out")));
        assertEquals(solution, content);
    }
