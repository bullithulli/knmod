...
public class TestParserTest {
	...
	public void parseTest5() {
		...
		String sol = """
				...
				""";
		parser renpyParser = new parser();
		assertEquals(sol.trim(), renpyParser.parseLine(rpyCode, false, 4).getChainString(0, -1, true, true).trim());
	}
	...
	public void parserTest1() {
		...
		String solution = """
				...
				hello
				World""";
		assertEquals(solution, renpyParser.parseLine(content, false, 4).getChainString(0, -1, true, true).trim());
	}
}
