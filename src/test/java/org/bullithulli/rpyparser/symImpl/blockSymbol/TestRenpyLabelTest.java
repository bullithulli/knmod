...
public class TestRenpyLabelTest {
    ...
    public void test2() {
        String rpyCode = """
                ...
                """;
        parser renpyParser = new parser();
        assertEquals(renpyParser.parseLine(rpyCode, true).getChainString(0, -1, true, true).trim(), rpyCode.trim());
    }
    ...
    public void test3() {
        String rpyCode = """
                ...
                label nine""";
        parser renpyParser = new parser();
        assertEquals(renpyParser.parseLine(rpyCode, true).getChainString(0, -1, true, true).trim(), rpyCode);
    }
