...
public class Modder2 {
    public static final String version = "Jan-2026-alpha0.1";
    ...
    public void verifyAndExecuteTranslateFeature(String sourceFile, String tlFile, String destinationFile, boolean isTabIntended) throws Exception {
        // TODO: 1/15/24 Write UnitTests
        boolean forceExit = false;
        if (sourceFile == null) {
    ...
    public void executeArgs() throws Exception {
        if (isKnMODFeatureRequested) {
            ...
            verifyAndExecuteTranslateFeature(inputFileForRequestedFeature, tlFile, outputFileForRequestedFeature, indentTypeTAB);
        } else {
