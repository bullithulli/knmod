...
import org.bullithulli.rpyparser.symImpl.nonBlockSymbol.renpyReturn;
...
import static org.bullithulli.rpyparser.RENPY_SYMBOL_TYPE.RENPY_CALL;
import static org.bullithulli.rpyparser.RENPY_SYMBOL_TYPE.RENPY_GENERIC_BLOCK_SYMBOLS;
import static org.bullithulli.rpyparser.RENPY_SYMBOL_TYPE.RENPY_GENERIC_NON_BLOCK_SYMBOLS;
...
import static org.bullithulli.rpyparser.RENPY_SYMBOL_TYPE.RENPY_NO_SPEAKER_TEXT;
import static org.bullithulli.rpyparser.RENPY_SYMBOL_TYPE.RENPY_RETURN;
import static org.bullithulli.rpyparser.RENPY_SYMBOL_TYPE.RENPY_SPEAKER_TEXT;
import static org.bullithulli.rpyparser.RENPY_SYMBOL_TYPE.ROOT_LABEL;
...
import static org.bullithulli.utils.textUtils.getUncommentedString;
...
public class parser {
	...
	final String regex_detect_for_block_symbols = "^\\s*([a-zA-Z_,.:$\\-\"'’\\?][a-zA-Z0-9_А-Яа-яЁё,:\\\\<>.*…&+/%\\-=\"(\\)\\{\\}\\s\\t”“#’'\\?\\|\\]\\[!]*)\\s*(:|and|or|\\{|\\()\\s*(?:#.*)?$";
